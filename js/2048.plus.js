...
var margin = 0.023 * documentWidth;
var game_width = 0.92 * documentWidth;
var box_width = 0.09 * documentWidth;
var numSize = 0.06 * documentWidth;
...
function drawBox(cxt, i, j, nums){
    ...
    cxt.font = numSize + "px Proggy";  // 60px Arial
    ...
    switch (nums) {
        ...
        case 128:
            ...
            cxt.fill();
            cxt.beginPath();
            cxt.font = (0.7 * numSize) + "px Proggy";
            cxt.fillStyle = color_text2;
            cxt.fillText(nums, x + box_width / 2, y + box_width / 2);
            break;
        case 256:
